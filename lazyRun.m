...
function [CLM,nCLM,CLMt,nCLMt,PLMt,nPLMt] = lazyRun(StructName)
...
% Don't worry about the median criterion
[CLM] = lazyMP(rdsEMG,ldsEMG,rLM,lLM,epochStage,0);

% Remove movements that don't pass median
[nCLM] = lazyMP(rdsEMG,ldsEMG,rLM,lLM,epochStage,1);

[PLMt,CLMt] = minimasterPlanForPLMt(CLM,in.minIMI,in.fs,in.maxIMI,3);
[nPLMt,nCLMt] = minimasterPlanForPLMt(nCLM,in.minIMI,in.fs,in.maxIMI,3);
